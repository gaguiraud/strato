...
const requiredEnvVars = {
  ...
  GITHUB_TOKEN_SECRET: process.env.GITHUB_TOKEN_SECRET,
...
if (!isGitHubConfigured) {
  console.log('⚠️  GitHub OAuth not configured. Missing or invalid environment variables:', missingVars.join(', '));
  console.log('🔧 Please update your .env file with valid GitHub OAuth credentials');
